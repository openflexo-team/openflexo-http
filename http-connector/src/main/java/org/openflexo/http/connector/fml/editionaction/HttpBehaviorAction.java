...
public class HttpBehaviorAction extends ActionSchemeAction {
	...
	@Override
	public HttpRequestBehavior getActionScheme() {
		return (HttpRequestBehavior) super.getActionScheme();
	}
