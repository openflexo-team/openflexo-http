...
/**
 * Provides execution environment of a {@link HttpInitializer} on a given {@link HbnVirtualModelInstance} as a {@link FlexoAction}
 * 
 * @author sylvain
 *
 */
public class HttpInitializerAction extends AbstractActionSchemeAction<HttpInitializerAction, HttpInitializer, HttpVirtualModelInstance<?>> {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(HttpInitializerAction.class.getPackage().getName());
	 ...
	 * @param editor
	 */
	public HttpInitializerAction(HttpInitializer behaviour, HttpVirtualModelInstance<?> focusedObject,
