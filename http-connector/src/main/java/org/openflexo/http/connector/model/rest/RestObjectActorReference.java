...
@XMLElement
public interface RestObjectActorReference extends HttpObjectActorReference {

	abstract class RestObjectActorReferenceImpl extends HttpObjectActorReferenceImpl implements RestObjectActorReference {
