...
var RemoteCursorManager = /** @class */ (function () {
    ...
    RemoteCursorManager.prototype.addCursor = function (id, color, label) {
        ...
        var cursorWidget = new RemoteCursorWidget_1.RemoteCursorWidget(id, this._options.editor, widgetId, this._options.className, color, label, this._options.tooltips, tooltipDurationMs, this._options.showTooltipOnHover, this._options.tooltipClassName, function () { return _this.removeCursor(id); });
    ...
    /**
     * A helper method that gets all the cursors
     * @internal
     */
    RemoteCursorManager.prototype.getCursors = function () {

        return this._cursorWidgets.values();
    };
...
var RemoteCursor = /** @class */ (function () {
    ...
    /**
     * Gets the low level id of this cursor.
     *
     * @returns
     *   The low level of this cursor.
     */
    RemoteCursor.prototype.getCursorId = function () {
        return this._delegate.getCursorId();
    };
    /**
     * Gets the label of this cursor.
     *
     * @returns
     *   The label of this cursor.
     */
    RemoteCursor.prototype.getLabel = function () {
...
var RemoteCursorWidget = /** @class */ (function () {
    function RemoteCursorWidget(id, codeEditor, widgetId, className, color, label, tooltipEnabled, tooltipDuration, showTooltipOnHover, tooltipClassName, onDisposed) {
        var _this = this;
    ...
    RemoteCursorWidget.prototype.getCursorId = function () {
        return this._cursorId;
    };
    RemoteCursorWidget.prototype.getLabel = function () {
        return this._label;
    };
    RemoteCursorWidget.prototype.getColor = function () {
        return this._color;
    };
